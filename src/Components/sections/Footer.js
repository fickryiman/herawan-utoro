...
const Footer = () => {
  ...
  return (
    <section className="footer">
      ...
      <div className="foot3">
        ...
        <ul>
          ...
          <li>
              ...
              <p>consult@herawanutoro.com</p>
          </li>
          <li>
              <FontAwesomeIcon icon={faLocationArrow} />
              <p>Jl. Dr. Wahidin. S, Pontianak Kalimantan Barat 78113</p>
          </li>
          <li>
      ...
      <p id='copy'>&copy; 2023. Herawan Utoro & Rekan</ p>
      <p id='copy'>Build with &#10084; by Fickry Bil Iman</p>
    </section>
  )
}
